...
`}</style>
      ...
      >
        ...
        >
          ...
          >
            <span style={{ fontStyle: 'italic', color: accent }}>Monetize</span>{' '}
            your
            <br />
            data today
          </h1>
        ...
        >
          ...
          >
            <div>
              ...
              >
                Submit data to community pools, earn rewards, and build reputation
          ...
          >
            <div>
              ...
              >
                Upload to decentralized storage, mint DataCoins, and enable
                trading on the open marketplace.
              </p>
            </div>
            <div
              style={{
          ...
          <div style={{ display: 'flex', gap: 64, flexWrap: 'wrap' }}>
            {[
              ...
              },
              {
                title: 'Connect',
                links: [
                  { label: 'X', url: 'https://x.com/myrad_hq' },
                  {
                    label: 'Telegram',
                    url: 'https://t.me/+d0dhyHWulJU4NTc1'
                  }
                ]
              }
            ].map((col, i) => (
